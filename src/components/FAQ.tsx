            ...
            <Reveal delay={0.2}>
              <div className="mt-10 rounded-3xl border border-ink-900/12 bg-white p-7">
                ...
                <p className="mt-3 font-display text-xl font-semibold">
                  One message on LinkedIn starts everything.
                </p>
                <a
                  href={LINKEDIN}
                  target="_blank"
                  rel="noreferrer noopener"
                  className="group mt-5 inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.2em] text-ink-900"
                >
                  <span className="link-slide">Message on LinkedIn</span>
